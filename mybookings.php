...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT * FROM Manufacturer rc, vehicle c
    WHERE rc.customer_username='$login_customer' AND c.vehicle_id=rc.car_id AND rc.return_status='R'";
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">You have not rented any parts till now!</h1>
        <p class="text-center"> Please rent parts in order to view your data here. </p>
      </div>
    </div>
