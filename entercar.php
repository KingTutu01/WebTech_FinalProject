...
<body>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
              ...
              <li> <a href="enterdriver.php"> Add Vehicle Part</a></li>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Please Provide Your Vehicle Part Details. </h3>

          <div class="form-group">
            <input type="text" class="form-control" id="vehicle_name" name="vehicle_name" placeholder="Car Name " required autofocus="">
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="vehicle_nameplate" name="vehicle_nameplate" placeholder="Vehicle Number Plate" required>
          </div>     
    ...
    <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> My Vehicle Parts </h3>
<?php
// Storing Session
$user_check=$_SESSION['login_client'];
$sql = "SELECT * FROM vehicle WHERE car_id IN (SELECT car_id FROM Manufacturer WHERE client_username='$user_check');";
...
<div style="overflow-x:auto;">
  <table class="table table-striped">
    <thead class="thead-dark">
      <tr>
        <th></th>
        <th width="24%"> Name Of Part</th>
        <th width="15%"> Part Plate  </th>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $row["vehicle_nameplate"]; ?></td>
      ...
      <td><?php echo $row["vehicle_availability"]; ?></td>
  ...
  <?php } ?>
    ...
    <br>
  <?php } else { ?>
  <h4><center> No vehicle parts available</center> </h4>
  <?php } ?>
        </form>
</div>        
        </div>
