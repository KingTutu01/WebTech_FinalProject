    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
              ...
              <li> <a href="enterdriver.php"> Add Supplier</a></li>
...
$sql0 = "SELECT rc.id, rc.rent_end_date, rc.charge_type, rc.rent_start_date, c.vehicle_name, c.vehicle_nameplate FROM CarHistory rc, vehicle c WHERE id = '$id' AND c.car_id = rc.car_id";
...
if(mysqli_num_rows($result0) > 0) {
    while($row0 = mysqli_fetch_assoc($result0)){
            ...
            $car_name = $row0["vehicle_name"];
            $car_nameplate = $row0["vehicle_nameplate"];
...
if($charge_type == "days"){
    ...
    $sql1 = "UPDATE CarHistory SET car_return_date='$car_return_date', no_of_days='$no_of_days', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
} else {
    $distance = $distance_or_days;
    $sql1 = "UPDATE CarHistory SET car_return_date='$car_return_date', distance='$distance', no_of_days='$duration', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
}

$result1 = $conn->query($sql1);

if ($result1){
     $sql2 = "UPDATE vehicle c, supplier d, CarHistory rc SET c.vehicle_availability='yes', d.supplier_availability='yes' 
     WHERE rc.car_id=c.car_id AND rc.supplierr_id=d.supplier_id AND rc.customer_username = '$login_customer' AND rc.id = '$id'";
...
?>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Car part Returned</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center"> Thank you for visiting Netsa Automobile! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                <h4> <strong>Vehicle Part Name: </strong> <?php echo $car_name;?></h4>
                <br>
            ...
            ?></h4>
                <br>
                <h4> <strong>Booking Part Date: </strong> <?php echo date("Y-m-d"); ?> </h4>
                <br>
                <h4> <strong>Start Date: </strong> <?php echo $rent_start_date; ?></h4>
                <br>
                <h4> <strong>Rent Part End Date: </strong> <?php echo $rent_end_date; ?></h4>
                <br>
                <h4> <strong>Part Return Date: </strong> <?php echo $car_return_date; ?> </h4>
                <br>
                ...
                ?>
                <h4> <strong>Total Fine:</strong> <label class="text-danger"> Ghc. <?php echo $total_fine; ?>/- </label> for <?php echo $extra_days;?> extra days.</h4>
                <br>
                <?php } ?>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> Netsa Automobile </h5>
                </div>
            </div>
        </div>
    </footer>
