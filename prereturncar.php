...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT c.vehicle_name, rc.rent_start_date, rc.rent_end_date, rc.fare, rc.charge_type, rc.id FROM rentedcars rc, cars c
...
<div class="container">
      <div class="jumbotron">
        <h1 class="text-center">Return your parts here</h1>
...
<tr>
<th width="30%">Car</th>
<th width="20%">Booking Start Date</th>
<th width="20%">Rent Part End Date</th>
<th width="20%">Fare</th>
...
<?php        } ?>
        ...
        <?php } else {
            ...
            <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">No parts to return.</h1>
        <p class="text-center"> Hope you enjoyed our service </p>
      </div>
    </div>
