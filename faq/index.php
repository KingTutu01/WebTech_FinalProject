...
<head>
    ...
    <title>FAQ | Netsa Automobile </title>
</head>
    ...
    <section class="cd-faq">
        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Netsa gladly accepts Mastercard and Visa. Personal Checks are also accepted providing you purchase CDW and Theft Protection on your rental.
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">What if i find a better rate for a rented part?</a>
                    <div class="cd-faq-content">
                        <p>One of the many great things about Netsa is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable vehicle including the same terms, locations, and rented part fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">Will i need a driving license to rent a part?</a>
                    <div class="cd-faq-content">
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">Is there a fee if i return the part after the due date?</a>
                    <div class="cd-faq-content">
                        <p>Yes, we charge Ghc200/- day after the due date.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
            </ul>
            ...
            <ul id="chauffeur" class="cd-faq-group">
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">How can i pay for my delivery services?</a>
                    <div class="cd-faq-content">
