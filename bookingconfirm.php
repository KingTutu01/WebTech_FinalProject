...
<body>
    ...
    $driver_id = $_POST['supplier_id_from_dropdown'];
    ...
    $sql0 = "SELECT * FROM vehicle WHERE car_id = '$car_id'";
    ...
    if ($err_date >= 0) {
        $sql1 = "INSERT into CarHistory(customer_username,car_id,supplier_id,booking_date,rent_start_date,rent_end_date,fare,charge_type,return_status) 
    VALUES('" . $customer_username . "','" . $car_id . "','" . $driver_id . "','" . date("Y-m-d") . "','" . $rent_start_date . "','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "')";
        $result1 = $conn->query($sql1);

        $sql2 = "UPDATE vehicle SET vehicle_availability = 'no' WHERE car_id = '$car_id'";
        $result2 = $conn->query($sql2);

        $sql3 = "UPDATE supplier SET supplier_availability = 'no' WHERE supplier_id = '$driver_id'";
        $result3 = $conn->query($sql3);

        $sql4 = "SELECT * FROM vehicle c, clients cl, supplier d, CarHistory rc WHERE c.car_id = '$car_id' AND d.supplier_id = '$driver_id' AND cl.client_username = d.client_username";
        ...
        if (mysqli_num_rows($result4) > 0) {
            while ($row = mysqli_fetch_assoc($result4)) {
                ...
                $car_nameplate = $row["vehicle_nameplate"];
                $driver_name = $row["supplier_name"];
                $driver_gender = $row["supplier_gender"];
                $dl_number = $row["sl_number"];
                $driver_phone = $row["supplier_phone"];
    ...
    ?>
        ...
        <h2 class="text-center"> Thank you for using Netsa Automobile System! We wish you have a safe ride. </h2>
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="col-md-10" style="float: none; margin: 0 auto; ">
                    ...
                    if ($charge_type == "days") {
                    ?>
                        <h4> <strong>Fare:</strong> Ghc. <?php echo $fare; ?>/day</h4>
                    <?php } else {
                    ?>
                        <h4> <strong>Fare:</strong> Ghc. <?php echo $fare; ?>/km</h4>
                    ...
                    <br>
                    <h4> <strong>Supplier Name: </strong> <?php echo $driver_name; ?> </h4>
                    <br>
                    <h4> <strong>Supplier Gender: </strong> <?php echo $driver_gender; ?> </h4>
                    <br>
                    <h4> <strong>Supplier License number: </strong> <?php echo $dl_number; ?> </h4>
                    <br>
